...
const Approach = () => {
	return (
		<section className='h-full flex flex-col-reverse lg:flex-row-reverse items-start gap-8 justify-center p-4 md:px-16 lg:max-w-7xl lg:mx-auto'>
			<div className='flex flex-col gap-4 lg:gap-8 lg:w-1/2'>
				...
				<div className='flex flex-col gap-4 text-base lg:text-xl text-slate-500'>
					...
					<p className=''>
						...
						understand the unique challenges faced by rural youth.
						Our interventions target areas most vulnerable to
						climate change, with limited access to education and
						healthcare.
					</p>
					<p className=''>
						...
						educating them about climate change, enabling them to
						adapt and mitigate its impacts.
					</p>
					<p className=''>
						Embracing technology as a cornerstone, our future vision
						is to integrate innovative tech solutions into all
						program dimensions, ensuring a brighter future for rural
						youth.
					</p>
				</div>
			</div>
